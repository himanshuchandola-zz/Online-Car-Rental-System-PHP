...
<br><br>
			<section class="caption">
				<h3 class="caption" style="text-align: center"><p><img src="img/register.png"><br><br><p><h1></h1></p></center></p></h3>
				...
				<p><center><h1>Register Here</h1></p>
				<form method="post">
					<table>
						<tr>
							<td>Full Name:</td>
						...
						<tr>
							<br><br><td colspan="2" style="text-align:right"><input type="submit" name="save" value="Submit Details"></td>
						</tr>
					</table>
				</form></center>
				<?php
